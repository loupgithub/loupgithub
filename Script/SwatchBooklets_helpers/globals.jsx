...
SWBL.C.LOWERCASE_FIELDNAME_COLORTYPE   = "colortype";
...
SWBL.C.LOWERCASE_COLORTYPE_CMYK        = "cmyk";
SWBL.C.LOWERCASE_COLORTYPE_RGB         = "rgb";

SWBL.C.SET_LOWERCASE_COLORTYPE         = {};
SWBL.C.SET_LOWERCASE_COLORTYPE[SWBL.C.LOWERCASE_COLORTYPE_CMYK] = true;
SWBL.C.SET_LOWERCASE_COLORTYPE[SWBL.C.LOWERCASE_COLORTYPE_RGB]  = true;
